...
<div class="panel panel-border main-layout">
    <div class="panel-heading panel-customized">BIBLIOTECARIOS</div>
                ...
                <div style="max-width: 500px; margin: 0 auto">
                    <div id="custom-toolbar">
                        <div class="form-inline" role="form">
                            <a class="btn btn-primary" href="{{route('biblioteca.users.create')}}" role="button"><i
                                    class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;Registrar</a>
                        </div>
                    </div>
                    <table id="table-users" data-height="500" data-sort-name="nombre" data-sort-order="desc"
    ...
    $(function () {
        $('#table-users').bootstrapTable({
            ...
            .on('click-row.bs.table', function (e, row, $element) {
                var modal =  $('#modal');
                var data = row
                $('#enlace').attr('href', 'users/'+data.id+'/edit' ) ;
