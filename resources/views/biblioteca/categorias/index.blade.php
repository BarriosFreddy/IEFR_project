...
<div class="panel panel-border main-layout">
    <div class="panel-heading panel-customized">CATEGORIAS</div>
                ...
                <div style="max-width: 500px; margin: 0 auto">
                    <div id="custom-toolbar">
                        <div class="form-inline" role="form">
                            <a class="btn btn-primary" href="{{route('biblioteca.categorias.create')}}" role="button"><i
                                    class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;Registrar</a>
                        </div>
                    </div>
                    <table id="table-categorias" data-height="530" data-sort-name="nombre" data-sort-order="desc"
