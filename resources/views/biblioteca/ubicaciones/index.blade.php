...
<div class="panel panel-border main-layout">
    <div class="panel-heading panel-customized">UBICACIONES</div>
                ...
                <div style="max-width: 500px; margin: 0 auto">
                    <div id="custom-toolbar">
                        <div class="form-inline" role="form">
                            <a class="btn btn-primary" href="{{route('biblioteca.ubicaciones.create')}}" role="button"><i
                                    class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;Registrar</a>
                        </div>
                    </div>
                    <table id="table-ubicaciones" data-height="500" data-sort-name="nombre" data-sort-order="desc"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLabel">Informacón</h4>
            </div>
...
<script>
    $(function () {
        $('#table-ubicaciones').bootstrapTable({
            data: <?php echo $ubicaciones?>
        })
            .on('click-row.bs.table', function (e, row, $element) {
                var modal =  $('#modal');
                var data = row
                $('#enlace').attr('href', 'ubicaciones/'+data.id+'/edit' ) ;
